...
class SectionController extends Controller
{
	 ...
	 */
        ...
        public function actionCreate()
        {
            ...
            /*
            if(isset($_POST['ajax']) && $_POST['ajax']==='section-Create-form')
            {
	...
	public function actionIndex($id)
	{
		...
		$programmeCode = Yii::app()->session['programmeCode'];
                $condition = "batchName='{$id}' and programmeCode='{$programmeCode}'";
	...
	{
		$model=Section::model()->findByPk(array('sectionName'=>$id,'batchName'=>yii::app()->session['batchName'],'programmeCode'=>yii::app()->session['programmeCode']));
		if($model===null)
