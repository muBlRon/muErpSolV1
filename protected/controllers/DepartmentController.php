...
class DepartmentController extends Controller
{
	...
	public function actionView($id)
	{
        ...
        public function actionSchDptView($id)
	{
           
		$this->render('view',array(
			'model'=>$this->loadModelBySchool($id),
		));
	}
	/**
	 * Creates a new model.
	...
	public function loadModel($id)
	{
        ...
        public function loadModelBySchool($id)
	{
		//$model=Department::model()->findAllByAttributes(array("schoolID"=>$id));
                $model=Department::model()->findByAttributes(array("schoolID"=>$id));
